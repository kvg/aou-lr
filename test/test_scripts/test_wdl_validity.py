...
@pytest.mark.parametrize(
    ...
    (
        ...
        ["miniwdl",  "check", ["wdl", "wdl/tasks"]],  # miniwdl validation is stricter and takes more time than womtool, so we only run it on 'pipelines' and 'tasks' since 'deprecated' will eventually be deleted.
    )
)
